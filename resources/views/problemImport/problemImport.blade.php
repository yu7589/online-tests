                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <form class="form-horizontal" method="post" action="/online-tests/public/problemImport">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="firstname" class="col-sm-2 control-label">QU</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="QU" placeholder="请输入QU">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-2 control-label">SO</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="SO" placeholder="请输入SO">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-2 control-label">QF</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lastname" placeholder="请输入QF">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-2 control-label">SF</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="SF" placeholder="请输入SF">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-2 control-label">AN</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="AN" placeholder="请输入AN">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lastname" class="col-sm-2 control-label">CO</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="CO" placeholder="请输入CO">
                                    </div>
                                </div>
