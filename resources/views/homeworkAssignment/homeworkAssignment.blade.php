            ...
            <div class="card-body row">
                ...
                <div class="col-md-4">
                    <div class="input-group ">
                        <a href="http://localhost/online-tests/public/autoTestPaper/submit"><button type="button" class="btn btn-info">查看候选作业表单中题目</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="hight:1000px">
            <div class="card" style="width:240px;float:right;margin-left:40px;margin-top:45px;">
                ...
                <form method="get" action="/online-tests/public/autoTestPaper">
                    ...
                    <button type="submit" class="btn btn-info" onclick="show()">将选中题目提交到候选作业表单</button>
                </div>
            </div>
        </div>
    <div>
